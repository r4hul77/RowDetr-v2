        ...
        for root, dirs, files in tqdm.tqdm(os.walk(dir)):
            for file in files:
                if(file.endswith('tiff')):
                    ...
                    out = im.convert("RGB")
                    out.save(os.path.join(self.output_dir, f"{prefix}_{i}.jpg"), "JPEG", quality=90)
                    i += 1
...
if __name__ == "__main__":
    ...
    dir = "/mnt/data/nav_dataset_corn_v3"
    dir = "/home/r4hul-lcl/data/data/nav_corn_v6"
    uploader = LabelBoxUploaderTiff(labelbox_api_key, "corn_v6", dir, "corn_v6")
